<?php
session_start();
if (!isset($_SESSION["uName"]) || $_SESSION["uId"] != $_GET["c_id"]) {
...
<div class="container-fluid">
    <div class="row">
                    ...
                    <ul class="nav flex-column my-3">
                        <li class="nav-item">
                            <a class="nav-link active">
                                ...
                                <span class="sr-only" id="customerInfoNav">Hoş Geldiniz, (name + surname).</span>
                            </a>
                        </li>
                    </ul>
                </div>
        ...
        <div class="col col-md-10 ">
            ...
            <div class="row m-3">
                <div id="customerMuayenelerTableDataDetaylarcss" class="m-3 dataTableUpdtTableCustom "
                     style="width: %100">
                    <h3 class="text-center">Muayene Detayları</h3>
                    <button class="btn btn-success m-3 float-end" id="borcOdeBtn">Borcu Öde</button>
                ...
                <div class="row m-3">
                    <div id="customerMuayenelerTableDatacss" class="m-3 dataTableUpdtTableCustom" style="width: %100">
                        <h3 class="text-center">Tüm Muayeneleriniz</h3>
                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col-md-16 col-lg-16 mx-auto">
                                        ...
                                        <div id="modalDisGuncelleForm" name="modalDisGuncelleForm">
                                            <div class="form-floating mb-3">
                                                <span type="number" class="form-control" id="disFlagForm"
                                                      name="disFlagForm"
                                                      placeholder="Diş işlem Görme Durumu">
                                                </span>
                                        ...
                                        <div class="form-floating mb-3">
                                        <span class="form-control" id="disYapilanIslemForm" rows="3"
                                              name="disYapilanIslemForm"
                                              placeholder="Diş İşlem Özeti"
                                              required>
                                        </span>
                                        ...
                                        <div class="form-floating mb-3">
                                        <span type="number" class="form-control" id="disUcretForm"
                                              name="disUcretForm"
                                              placeholder="Yapılan İşlemlerin Tutarını Giriniz" required>
                                        </span>
                                            <label for="disUcretForm">
                                                Dişe Uygulanan İşlem Ücreti:
                                            </label>
                                        </div>
                                    </div>
                                </div>
    ...
    <div class="modal" id="modalOdeme" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title text-center">Borç Ödeme</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"
                            onclick="odemeModalClose()">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body" id="modalOdemeDataBody">
                    <div class="row g-0">
                        <div class="container-fluid text-end" id="modalOdemeBasariliAlert"
                             style="display: none">
                            <div class="alert alert-success d-inline-flex p-2 text-center" role="alert">
                                <svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
                                    <symbol id="check-circle-fill" fill="currentColor" viewBox="0 0 16 16">
                        ...
                        <div class="container text-end" id="modalOdemeHataliAlert" style="display: none">
                            <div class="alert alert-danger d-inline-flex p-2 text-center" role="alert">
                                <svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
                                    <symbol id="exclamation-triangle-fill" fill="currentColor"
                                            viewBox="0 0 16 16">
                                ...
                                <div>
                                    Ödeme Yapılamadı, Girilen Miktar Ödenecek Borçtan Fazla Olmamalı, Lütfen Tekrar
                                    Deneyiniz !
                                </div>
                            </div>
                        </div>
                        <div class="login d-flex align-items-center py-5">
                            <div class="container">
                                <div class="row">
                                    <div class="col-md-16 col-lg-16 mx-auto">
                                        <h2 class="login-heading mb-4 text-center" id="ex_id_h2">X</h2>
                                        <div id="modalDisGuncelleForm" name="modalDisGuncelleForm">
                                            <div class="form-floating mb-3">
                                                <span type="number" class="form-control" id="toplamBorcSpan">
                                                </span>
                                                <label for="toplamBorcSpan">
                                                    Toplam Borç:
                                                </label>
                                            </div>
                                        </div>
                                        <div id="modalDisGuncelleForm" name="modalDisGuncelleForm">
                                            <div class="form-floating mb-3">
                                                <span type="number" class="form-control" id="odenebilirBorcSpan">
                                                </span>
                                                <label for="toplamBorcSpan">
                                                    Ödenebilir Miktar:
                                                </label>
                                        ...
                                        <div class="form-floating mb-3">
                                            <input class="form-control" id="OdenecekMiktarInpt"
                                                   type="number"
                                                   name="OdenecekMiktarInpt"
                                                   oninput="this.value = odemeFormat(this.value)"
                                                   placeholder="OdenecekMiktarInpt"
                                                   required>
                                            <label for="disYapilanIslemForm">
                                                Odenecek Miktar
                                                <span class="text-info ms-2">(Odenen Miktar Toplam Borca Eşit Yada Küçük Olmalıdır)</span>
                                            </label>
                                            <div class="valid-feedback" id="odemeYapilabilirValid">Ödeme Yapılabilir.</div>
                                            <div class="invalid-feedback" id="odemeYapilamazInvalid">Odenen Miktar Toplam Borca Eşit Yada Küçük Olmalıdır! Ödeme Yapılamaz</div>
                                        </div>
                                        <div class="text-md-center">
                                            <button class="btn btn btn-primary" id="odemeyiYapModalBtn"
                                                    name="odemeyiYapModalBtn"
...
<?php
echo "<script>fillNavBarUserİnfo('" . $_GET['c_fullname'] . "')</script>\n";
